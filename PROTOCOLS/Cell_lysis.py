...
# This protocol takes 100 uL of solution from the first column of the reservoir and puts it in well A2 of the first 96-well plate, then takes another 100uL from the reservoir (first column) and puts it in well A3 of the 96-well plate; so on until reach well A11. At the end, mix each well 2 times from A2 to A11, and between each well wash the tip in well A12 of the reservoir.
# If it is done for more than one plate, first do what was mentioned above for the first plate, and then do the same for the second, only this time it will take the 100 uL from column A2 of the reservoir.
# Therefore, it will be necessary to prepare manually in the reservoir a solution to wash the tips (e.g. bleach) in column A12 of the reservoir, and in each column you will use of the reservor (consider one column per plate), you will have to put 10 mL of the lisis solution.
